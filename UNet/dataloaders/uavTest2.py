...
class UAVDataset(BaseDataSet):
    ...
    def _set_files(self):
        ...
        img_path = os.path.join(self.root, img_dir_name)
        label_path = os.path.join(self.root, img_dir_name)
        ...
        label_paths.extend(sorted(glob(os.path.join(img_path, f'*{SUFIX_LABEL}'))))
